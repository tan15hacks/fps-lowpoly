...
export class PlayerController {
    ...
    constructor(cameraController, stats, collision) {
    ...
    update(delta, input) {
        ...
        if (sprinting)
            this.stats.stamina = Math.max(0, this.stats.stamina - delta * 0.25);
        else {
            this.stats.stamina = Math.min(1, this.stats.stamina +
        ...
        this.cameraController.update(delta, Math.min(1, this.move.length()), sprinting, this.grounded, input.aim);
    }
